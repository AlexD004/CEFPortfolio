...
#prestations .blocService img{
    margin: -40px 0 20px 0;
}
#prestations .blocService p{
    line-height: 1.3;
}
#prestations .blocService p strong{
    font-weight: 700;
}
#prestations .blocService p::before{
    content:"";
    display: block;
    width:100%;
    height: 1px;
...
@media (min-width: 1024px) {
    ...
    #prestations .blocService:last-child{
        margin: 0;
    }
